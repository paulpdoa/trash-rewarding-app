        ...
        <div className="h-full relative bg-white">
            ...
            <div className="leaderboard-bg h-full py-44"> 
                <div className="flex justify-between px-5 items-end h-full">
                    ...
                    :
                    users?.sort((first,second) => first.collectedPoints - second.collectedPoints).slice(0,2).map((user,pos) => (
                        <div className={`relative ${pos + 1 === 1 ? 'bg-green-300' : 'bg-green-100'} rounded-md w-full ${pos + 1 === 1 ? 'h-32' : 'h-auto'}`}>
                ...
                <div className="bg-green-50 rounded-tl-2xl rounded-tr-2xl p-2 mt-4">
                    ...
                    :
                    users?.map((user) => (
                        <div className="flex p-2 items-center justify-between w-full border-b border-gray-300">
