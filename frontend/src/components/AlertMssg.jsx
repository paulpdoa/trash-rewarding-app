...
const AlertMssg = ({ message,redirect }) => {
    ...
    return (
        <div className="absolute top-0 h-screen flex justify-center items-center w-full">
            <div className="w-4/5 rounded-xl gap-2 border border-gray-200 shadow-lg bg-white p-3 h-32 brightness-100 z-50 text-center font-bold flex flex-col items-center justify-center relative">
